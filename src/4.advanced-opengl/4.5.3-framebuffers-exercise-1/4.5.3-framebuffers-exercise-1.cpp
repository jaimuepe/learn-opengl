...
int main() {
  ...
  float quadVertices[] = {
      // pos(x, y) // texcoords
      -0.2f, 0.8f, 0.0f, 1.0f, // top-left
      -0.2f, 0.4f, 0.0f, 0.0f, // bottom-left
       0.2f, 0.4f, 1.0f, 0.0f, // bottom-right

       0.2f, 0.4f, 1.0f, 0.0f, // bottom-right
       0.2f, 0.8f, 1.0f, 1.0f, // top-right
      -0.2f, 0.8f, 0.0f, 1.0f  // top-left
  };
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    // first pass - scene in the default framebuffer
    {
      glEnable(GL_DEPTH_TEST);
    ...
    // second pass - rear camera in the framebuffer
    {
      glEnable(GL_DEPTH_TEST);
    ...
    // third pass - framebuffer as a quad into the default framebuffer
    {
